 ...
 * @author Kevin
 */
public class MatriculaRetiro extends javax.swing.JDialog {

    
    public FrmMatricula frmMatricula;
     ...
     * @param IdMatricula
     */
    public MatriculaRetiro(Window parentWindow, String IdMatricula) {
        super(parentWindow);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(400, 414));
        ...
        jLabel3.setText("RETIRAR ALUMNO");
        ...
        jLabel4.setText("Motivo del retiro.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jdcFecha.setMinimumSize(new java.awt.Dimension(100, 20));
        jdcFecha.setPreferredSize(new java.awt.Dimension(140, 22));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        btnGuardar.setText("RETIRAR ALUMNO");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            dateEUA = formatoFechaEUA(date);
        } catch (ParseException ex) {
            Logger.getLogger(MatriculaRetiro.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        clsMatricula.EditarRetiro(idMatricula, "SI", dateEUA, motivo, con); 
        ClsConexion.closeConnection(con);
        frmMatricula.actualizarTabla();
        frmMatricula.activaBotones(true,false,false,false,false,false,true,false);
        this.dispose();                
        
    }//GEN-LAST:event_btnGuardarActionPerformed

    public void FormularioPadre(FrmMatricula frmMatricula)
    {
        this.frmMatricula = frmMatricula;
    }
