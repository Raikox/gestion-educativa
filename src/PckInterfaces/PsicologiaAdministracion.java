 ...
 * @author Kevin
 */
public class PsicologiaAdministracion extends javax.swing.JPanel {
     ...
     */
    public PsicologiaAdministracion() {
        initComponents();
        ...
        //true si esta habilitado para editar
        if(!codigoPeriodo.isEmpty()) {
            String idPeriodo = codigoPeriodo.get(cmbPeriodo.getSelectedIndex());
            CargarTablaCasosTodos(FrmPrincipal.editarCasoPsicologia,idPeriodo);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADMINISTRACION PSICOLOGIA");
        ...
        jTabbedPane2.setBackground(new java.awt.Color(237, 240, 242));
        ...
        jTabbedPane3.setMinimumSize(new java.awt.Dimension(284, 127));
        jTabbedPane3.setPreferredSize(new java.awt.Dimension(497, 506));
        ...
        tblCasos.setFont(new java.awt.Font("Droid Sans", 0, 11)); // NOI18N
        ...
        jTabbedPane1.setBackground(new java.awt.Color(237, 240, 242));
        ...
        txtAccion.setMinimumSize(new java.awt.Dimension(300, 300));
        ...
        jScrollPane5.setMinimumSize(new java.awt.Dimension(452, 250));
        ...
        btnNuevaAccion.setFont(new java.awt.Font("Droid Sans", 1, 12)); // NOI18N
        btnNuevaAccion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PckIconos/ic_add_black_24dp.png"))); // NOI18N
        btnNuevaAccion.setText("NUEVA ACCION");
        btnNuevaAccion.setEnabled(false);
        ...
        jPanel9.add(btnNuevaAccion, gridBagConstraints);
    ...
    private void tblAlumnoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAlumnoMouseClicked
        ...
        else
        {
            ...
            CargarTablaCasosAlumno(idMatricula,FrmPrincipal.editarCasoPsicologia);
    ...
    private void tblCasosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCasosMouseClicked
        ...
        else
        {
            ...
            {                   
                ...
                btnNuevaAccion.setEnabled(true);
            }
          
        }
    }//GEN-LAST:event_tblCasosMouseClicked

    public void CargarTablaPsicologiaAccion(String idPsicologiaCaso)
    {
    ...
    private void btnNuevaAccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevaAccionActionPerformed
        ...
        Window parentWindow = SwingUtilities.windowForComponent(this);
        PsicologiaAdministracionAccion accion = new PsicologiaAdministracionAccion(parentWindow,idCaso);
        accion.FormularioPadre(this);
        accion.setModal(true);
    ...
    public void CargarTablaCasosAlumno(String idMatricula,boolean editarEstado) //Aca me quede
    {
        String titulos[];
        
        if(editarEstado) //se puede editar
        {
            titulos = new String[7];
            titulos[0] = "ID";titulos[1] = "IDMAT";titulos[2] = "FECHA";titulos[3] = "ESTADO";
            titulos[4] = "PROBLEMA PRESENTADO";titulos[5] = "";titulos[6] = "";        
        }
        else //no se puede editar
        {
            
            titulos = new String[6];
            titulos[0] = "ID";titulos[1] = "IDMAT";titulos[2] = "FECHA";titulos[3] = "ESTADO";
            titulos[4] = "PROBLEMA PRESENTADO";titulos[5] = "";  
        }
        ...
        mr.getTableCellRendererComponent(tblCasos, fila, true, true, WIDTH, 0);
        mr.getTableCellRendererComponent(tblCasos, fila, true, true, WIDTH, 1);
        
        //tblCasos.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

    }
    
    private void CargarTablaCasosTodos(boolean editarEstado, String idPeriodo)
    {
        String titulos[];
        ...
        if(editarEstado) //se puede editar
        {
            ...
            titulos[0] = "ID";titulos[1] = "IDMAT";titulos[2] = "FECHA";titulos[3] = "ESTADO";
            titulos[4] = "ALUMNO";titulos[5] = "AULA";titulos[6] = "";titulos[7] = "";
        }
        else //no se puede editar
        {
            ...
            titulos = new String[7];
            titulos[0] = "ID";titulos[1] = "IDMAT";titulos[2] = "FECHA";titulos[3] = "ESTADO";
            titulos[4] = "ALUMNO";titulos[5] = "AULA";titulos[6] = "";
        }
        ...
        {
            TableColumn  cVer =tblCasosTodos.getColumnModel().getColumn(4);
            cVer.setPreferredWidth(120);
        }
    ...
    private String obtenerIdAlumno()
    {
        ...
        try 
        {
            ...
            Logger.getLogger(PsicologiaAdministracion.class.getName()).log(Level.SEVERE, null, ex);
        }
        return aux;
    }
