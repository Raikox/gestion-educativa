...
public class JTreeFile implements TreeExpansionListener{
     ...
     */
    public void init(String xNombre,String xRuta) {
        //creamos el nodo principal
        DefaultMutableTreeNode top = new DefaultMutableTreeNode(xNombre);
        ...
        {
            //Logger.getLogger(JTreeFile.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "El directorio no a podido ser ubicado o no existe. "
                    + "Verifique la siguiente dirección: \n "+xRuta, 
                    "Error al ubicar directorio", JOptionPane.ERROR_MESSAGE);
        }
    }
