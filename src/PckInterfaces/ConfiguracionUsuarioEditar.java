 ...
 * @author Kevin
 */
public class ConfiguracionUsuarioEditar extends javax.swing.JDialog {
    ...
    String idUsuario; String nombreRol;
     ...
     * @param NombreRol     
     */
    public ConfiguracionUsuarioEditar(Window parentWindow, String IdUsuario, String NombreRol) {
        super(parentWindow);
        ...
        try {
            ...
            Logger.getLogger(ConfiguracionUsuarioEditar.class.getName()).log(Level.SEVERE, null, ex);
        }
        CargarComboRol();
        SeleccionarUsuarioRol();
        ValidarCampos();
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            usuarioModelo.EditarUsuario(txtNombres, txtApellidoPaterno, txtApellidoMaterno, txtDni, txtTelefono, jdcFecha, cmbRol, idUsuario);
    ...
    private void CargarUsuarioDatos() throws ParseException {
        usuarioModelo.CargarUsuario(txtNombres, txtApellidoPaterno, txtApellidoMaterno, jdcFecha, txtDni, txtTelefono, idUsuario);
    }
    
    private void SeleccionarUsuarioRol() {
        usuarioModelo.SeleccionarUsuarioRol(cmbRol, nombreRol);
    }
