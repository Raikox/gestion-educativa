 ...
 * @author Kevin
 */
public class AlmacenAdministracionItemAgregar extends javax.swing.JDialog {
     ...
     * @param xIdAlmacen     
     */
    public AlmacenAdministracionItemAgregar(Window parentWindow, int xIdItem, int xStockAntiguo, int xIdAlmacen, boolean xConsumo) {
        super(parentWindow);
        _IdItem = xIdItem;
        _StockAntiguo = xStockAntiguo;
        _IdAlmacen = xIdAlmacen;
        _Consumo = xConsumo;
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(436, 309));
        setPreferredSize(new java.awt.Dimension(436, 330));
        ...
        jLabel3.setText("AGREGAR CANTIDAD");
        ...
        txtCantidad.setMinimumSize(new java.awt.Dimension(200, 20));
        txtCantidad.setPreferredSize(new java.awt.Dimension(250, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        btnGuardar.setText("AGREGAR CANTIDAD");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        nuevoStock = _StockAntiguo + Integer.parseInt(txtCantidad.getText());
        
        itemStockDAL.GuardarItemCantidad(
                txtFecha.getText(), 
                txtCantidad.getText(), 
        ...
        itemDAL.EditarItemStock(_IdItem, nuevoStock);        
        
        almacenAdministracionItem.CargarTablaUnidadesAsignadas(_IdItem);
        almacenAdministracionItem.CargarTablaAulaItems(String.valueOf(_IdAlmacen),_Consumo);
        this.dispose();
    ...
    {           
        ((AbstractDocument) txtCantidad.getDocument()).setDocumentFilter(filtroMayuscula);
    }
