 ...
 * @author Kevin
 */
public class AlmacenRequerimientoEditar extends javax.swing.JPanel {
     ...
     */
    public AlmacenRequerimientoEditar(int _IdAula,String _IdRequerimiento) {
    ...
    private void CargarDatosRequerimiento()
    {
        ...
        {
            Logger.getLogger(AlmacenRequerimientoEditar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        pnlTitulo1.setMinimumSize(new java.awt.Dimension(261, 50));
        pnlTitulo1.setPreferredSize(new java.awt.Dimension(261, 50));
        pnlTitulo1.setLayout(new java.awt.GridBagLayout());

        jLabel9.setFont(new java.awt.Font("Droid Sans", 1, 12)); // NOI18N
        jLabel9.setText("EDITAR REQUERIMIENTO ALMACÉN");
        ...
        btnEmitir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PckIconos/ic_mode_edit_black_24dp.png"))); // NOI18N
        btnEmitir.setText("GUARDAR REQUERIMIENTO");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        {            
            ...
            if(row != -1)
            {
                ...
                _StockRestante = String.valueOf(dtmItems.getValueAt(row, 3));//para validar que no sea 0
    ...
    private void AbrirDialogAlmacenRequerimientoNuevoPedido()
    {
        ...
        AlmacenRequerimientoNuevoPedido almacenRequerimientoNuevoPedido = new AlmacenRequerimientoNuevoPedido(parentWindow,true);
        almacenRequerimientoNuevoPedido.FormularioPadreEditar(this);
