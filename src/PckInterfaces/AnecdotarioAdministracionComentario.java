 ...
 * @author Kevin
 */
public class AnecdotarioAdministracionComentario extends javax.swing.JDialog {
    
    
    public AnecdotarioAdministracion anecdotarioAdministracion;
    DocumentFilter filtroMayuscula = new ClsMisc.UppercaseDocumentFilter(); 
    String _IdAnecdotario;    
     ...
     * @param idAnecdotario     
     */
    public AnecdotarioAdministracionComentario(Window parentWindow, String idAnecdotario) {
        super(parentWindow);
        _IdAnecdotario = idAnecdotario;
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(436, 414));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Connection con;
        ClsAnecdotarioComentario anecdotario = new ClsAnecdotarioComentario();
        ClsEntidadAnecdotarioComentario eanecdotario = new ClsEntidadAnecdotarioComentario();
        eanecdotario.setComentario_comentario(txtComentario.getText());
        eanecdotario.setComentario_fecha(fechaActual());
        eanecdotario.setAnecdotario_id(_IdAnecdotario);
        eanecdotario.setPersonal_id(FrmPrincipal.idPersonalLogeado);
        con = ClsConexion.getConection();
        anecdotario.GuardarAnecdotarioComentario(eanecdotario, con);
        
        ClsAnecdotario ane = new ClsAnecdotario();        
        ane.EditarAnecdotarioEstado("REVISADO", _IdAnecdotario, con);
        
        ClsConexion.closeConnection(con);
        
        anecdotarioAdministracion.CargarTablaAnecdotarioComentario(_IdAnecdotario);
        this.dispose();
        
    }//GEN-LAST:event_btnGuardarActionPerformed

    public void FormularioPadre(AnecdotarioAdministracion anecdotarioAdministracion)
    {
        this.anecdotarioAdministracion = anecdotarioAdministracion;
    }
