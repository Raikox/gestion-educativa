 ...
 * @author Kevin
 */
public class AlmacenAdministracionItemNuevo extends javax.swing.JDialog {
    ...
    public AlmacenAdministracionItemNuevo(Window parentWindow) 
    {
        super(parentWindow);        
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(642, 502));
        setPreferredSize(new java.awt.Dimension(642, 502));
        ...
        txtNombre.setNextFocusableComponent(txtMedida);
        ...
        jLabel10.setText("Unidades Asignadas.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel2.setText("<html>Una vez agregado el item <b>se mostrará las items sin asignar, usted necesitará agregarlo a un almacén.</b></html>");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        int last = itemDAL.GuardarItem(                
                txtNombre.getText(), 
                txtMedida.getText(), 
                (int) txtStock.getValue(),
                txtDescripcion.getText(),
                cmbTipo.getSelectedItem().toString()
        );
        
        itemStockDAL.GuardarItemCantidad(fechaActual(), 
                String.valueOf(txtStock.getValue()), 
